...
import clear_cart_img from "../assets/img/empty-cart.png"
import {Link} from "react-router-dom";

function Cart(){
    const dispatch = useDispatch()
    const {totalPrice, totalCount, items} = useSelector(({cartReducer}) => cartReducer)
    const cartProducts = Object.keys(items).map(key => {
                ...
                {   totalCount ?
                    <div className="cart">
                        ...
                        <div className="content__items">
                            {cartProducts &&
                            cartProducts.map((item, index) => (<CartItem key={item.id}
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Всего блюд: <b>{totalCount} шт.</b> </span>
                    ...
                    : <div className="cart cart--empty">
                        ...
                        <p>
                            ...
                            Для того, чтобы заказать что-то вкусное, перейди на главную страницу.
                        </p>
                        <img src={clear_cart_img} alt="Empty cart"/>
